...
void task100Hz()
{
    ...
    madgwick.update(gyroscopeX_dps, gyroscopeY_dps, gyroscopeZ_dps, accelerationX_mps2, accelerationY_mps2, accelerationZ_mps2, magnetometerX_nT, magnetometerY_nT, magnetometerZ_nT);
...
void setup()
{
    ...
    primary.setReferencePressure(1017.0);   // 削除
    secondary.setReferencePressure(1017.0); // 削除
